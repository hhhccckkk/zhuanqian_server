...
<div id="contentWrap">
  ...
  <div id="widget table-widget">
    <div class="pageTitle">昨天赚钱总计：  <h:property value="moneyBean.allMoney"/>
    ...
    <div class="pageColumn">
      ...
      <table>
        ...
        <h:iterator value="moneyList" var="j">
          ...
          <a href="getMoneyAllP2?page=<%=flag-1%>" class="STYLE6">上页</a>　
          <a href="getMoneyAllP2?page=<%=1>=pagenum?pagenum:1 %>" class="STYLE6">1</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=2>=pagenum?pagenum:2 %>" class="STYLE6">2</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=3>=pagenum?pagenum:3 %>" class="STYLE6">3</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=4>=pagenum?pagenum:4 %>" class="STYLE6">4</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=5>=pagenum?pagenum:5 %>" class="STYLE6">5</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=6>=pagenum?pagenum:6 %>" class="STYLE6">6</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=7>=pagenum?pagenum:7 %>" class="STYLE6">7</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=8>=pagenum?pagenum:8 %>" class="STYLE6">8</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=9>=pagenum?pagenum:9 %>" class="STYLE6">9</a>&nbsp;
         <a href="getMoneyAllP2?page=<%=10>=pagenum?pagenum:10 %>" class="STYLE6">10</a>&nbsp;
        <a href="getMoneyAllP2?page=<%=(flag+1)>=pagenum?pagenum:(flag+1)%>" class="STYLE6">下页&gt;</a>&nbsp;
            　</td>
          </tr>
        </tbody>
      </table>
