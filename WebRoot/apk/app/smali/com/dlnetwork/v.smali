...
.method static synthetic a(Lcom/dlnetwork/v;Landroid/content/Context;Lcom/dlnetwork/ay;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/dlnetwork/v;->b(Landroid/content/Context;Lcom/dlnetwork/ay;Ljava/lang/String;)V

    return-void
.end method

.method private b(Landroid/content/Context;Lcom/dlnetwork/ay;Ljava/lang/String;)V
    .locals 1

    new-instance v0, Lcom/dlnetwork/ae;

    invoke-direct {v0, p0, p2, p1, p3}, Lcom/dlnetwork/ae;-><init>(Lcom/dlnetwork/v;Lcom/dlnetwork/ay;Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/dlnetwork/ae;->start()V
...
# virtual methods
.method public a(Landroid/app/AlertDialog;Landroid/util/DisplayMetrics;Landroid/content/Context;Lcom/dlnetwork/ay;Ljava/lang/String;)V
    .locals 11
    ...
    new-instance v2, Lcom/dlnetwork/aa;

    invoke-direct {v2, p0, p1}, Lcom/dlnetwork/aa;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;)V
    ...
    iget-object v1, p4, Lcom/dlnetwork/ay;->l:Ljava/lang/Integer;
    ...
    new-instance v0, Lcom/dlnetwork/ab;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/dlnetwork/ab;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;Lcom/dlnetwork/ay;Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {v10, v0}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v0, Lcom/dlnetwork/ac;

    invoke-direct {v0, p0, p1}, Lcom/dlnetwork/ac;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;)V
    ...
    iget-object v1, p4, Lcom/dlnetwork/ay;->j:Ljava/lang/String;
    ...
    new-instance v0, Lcom/dlnetwork/ad;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/dlnetwork/ad;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;Lcom/dlnetwork/ay;Landroid/content/Context;Ljava/lang/String;)V
...
.method public a(Landroid/content/Context;Lcom/dlnetwork/ay;Ljava/lang/String;)V
    .locals 11
    ...
    iget-object v0, p2, Lcom/dlnetwork/ay;->b:Ljava/lang/Integer;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/dlnetwork/v;->a(Lcom/dlnetwork/ay;Landroid/util/DisplayMetrics;Landroid/app/AlertDialog;Landroid/content/Context;Ljava/lang/String;)V

    :cond_0
    :goto_0
    const-string v0, "xp_show"

    iget-object v1, p2, Lcom/dlnetwork/ay;->a:Ljava/lang/String;

    iget-object v2, p2, Lcom/dlnetwork/ay;->g:Ljava/lang/String;

    invoke-static {p1, v0, v1, v2, p3}, Lcom/dlnetwork/bg;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "al"

    const-string v1, ""

    invoke-static {p1, v0, v1}, Lcom/dlnetwork/bm;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p2, Lcom/dlnetwork/ay;->a:Ljava/lang/String;
    ...
    invoke-static {p1, v0, v1}, Lcom/dlnetwork/bm;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/dlnetwork/v;->a(Landroid/app/AlertDialog;Landroid/util/DisplayMetrics;Landroid/content/Context;Lcom/dlnetwork/ay;Ljava/lang/String;)V
...
.method public a(Lcom/dlnetwork/ay;Landroid/util/DisplayMetrics;Landroid/app/AlertDialog;Landroid/content/Context;Ljava/lang/String;)V
    .locals 13

    iget-object v1, p1, Lcom/dlnetwork/ay;->k:Ljava/lang/String;

    move-object/from16 v0, p4

    invoke-static {v0, v1}, Lcom/dlnetwork/ba;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v4, v4}, Lcom/dlnetwork/ba;->a(Landroid/graphics/Bitmap;FF)Landroid/graphics/Bitmap;
    ...
    new-instance v1, Lcom/dlnetwork/w;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/dlnetwork/w;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;Lcom/dlnetwork/ay;Landroid/content/Context;Ljava/lang/String;)V
    ...
    new-instance v2, Lcom/dlnetwork/x;

    move-object/from16 v0, p3

    invoke-direct {v2, p0, v0}, Lcom/dlnetwork/x;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;)V
    ...
    iget-object v1, p1, Lcom/dlnetwork/ay;->l:Ljava/lang/Integer;
    ...
    new-instance v1, Lcom/dlnetwork/y;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/dlnetwork/y;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;Lcom/dlnetwork/ay;Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {v11, v1}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    new-instance v1, Lcom/dlnetwork/z;

    move-object/from16 v0, p3

    invoke-direct {v1, p0, v0}, Lcom/dlnetwork/z;-><init>(Lcom/dlnetwork/v;Landroid/app/AlertDialog;)V
