...
<html>
  ...
  <body>
    <form action="addVison" method="post">
  <div align="center">
    <table width="614" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="3" rowspan="2" valign="top"><label>
          <textarea name="info.content" cols="48" rows="11"></textarea>
        </label></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="31">&nbsp;</td>
        <td >下载地址：</td>
        <td colspan="3" ><input name="info.downurl" type="text"/></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="29">&nbsp;</td>
        <td >版本：</td>
        <td colspan="3" valign="top"><input name="info.version" type="text"/></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="56">&nbsp;</td>
