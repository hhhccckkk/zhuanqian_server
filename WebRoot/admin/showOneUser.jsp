  ...
  <div align="center"><br>
    <table width="898" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="81" valign="top" ><a href="admin/getUserOrder?uid=<h:property value="user.id"/>">兑换记录</a></td>
        <td width="95" valign="top"><a href="admin/getUserJiLu?page=1&id=<h:property value="user.id"/>">赚钱记录</a></td>
        <td width="233">&nbsp;</td>
        <td width="131">&nbsp;</td>
        <td width="242">&nbsp;</td>
      </tr>
