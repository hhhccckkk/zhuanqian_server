...
--> 
 ...
 <script language="javascript" src="script/validation-framework.js" charset="GBK"></script>
  ...
  <body >
  <form action="addHongBao" method="post" >
  <div align="center">
        ...
        <td height="399" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#8ECCEA">
              <!--DWLayoutTable-->
              <tr>
                <td width="439" height="32"   background="images/bg.png"><span class="STYLE1" >增加红包</span><span class="STYLE2 STYLE1">&gt;&gt;</span></td>
                </tr>
              <tr>
                <td height="35"   >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户id：
                  <label>
                  <input name="hongbao.uid" type="text" size="25" >
                  
                </tr>
             <tr>
                <td height="35"   >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金币:
                  <label>
                  <input name="hongbao.point" type="text" size="25" >
                </tr>
              <tr>
              <tr>
                <td height="35"   >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;奖励金币原因:
                  <label>
                  <input name="hongbao.content" type="text" size="25" >
                </tr>
              <tr>
                <td height="40"  >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
