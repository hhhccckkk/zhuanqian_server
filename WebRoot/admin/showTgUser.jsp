    ...
    <div class="pageColumn">
      ...
      <table>
        ...
        <h:iterator value="users" var="u">
          ...
          <a href="getTgUsers?page=<%=flag-1%>&id=<%=id %>" class="STYLE6">上页</a>　
          <a href="getTgUsers?page=<%=1>=pagenum?pagenum:1 %>&id=<%=id %>" class="STYLE6">1</a>&nbsp;
         <a href="getTgUsers?page=<%=2>=pagenum?pagenum:2 %>&id=<%=id %>" class="STYLE6">2</a>&nbsp;
         <a href="getTgUsers?page=<%=3>=pagenum?pagenum:3 %>&id=<%=id %>" class="STYLE6">3</a>&nbsp;
         <a href="getTgUsers?page=<%=4>=pagenum?pagenum:4 %>&id=<%=id %>" class="STYLE6">4</a>&nbsp;
         <a href="getTgUsers?page=<%=5>=pagenum?pagenum:5 %>&id=<%=id %>" class="STYLE6">5</a>&nbsp;
         <a href="getTgUsers?page=<%=6>=pagenum?pagenum:6 %>&id=<%=id %>" class="STYLE6">6</a>&nbsp;
         <a href="getTgUsers?page=<%=7>=pagenum?pagenum:7 %>&id=<%=id %>" class="STYLE6">7</a>&nbsp;
         <a href="getTgUsers?page=<%=8>=pagenum?pagenum:8 %>&id=<%=id %>" class="STYLE6">8</a>&nbsp;
         <a href="getTgUsers?page=<%=9>=pagenum?pagenum:9 %>&id=<%=id %>" class="STYLE6">9</a>&nbsp;
         <a href="getTgUsers?page=<%=10>=pagenum?pagenum:10 %>&id=<%=id %>" class="STYLE6">10</a>&nbsp;
        <a href="getTgUsers?page=<%=(flag+1)>=pagenum?pagenum:(flag+1)%>&id=<%=id %>" class="STYLE6">下页&gt;</a>&nbsp;
            　</td>
          </tr>
        </tbody>
      </table>
