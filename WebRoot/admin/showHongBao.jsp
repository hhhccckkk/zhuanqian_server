...
<%
	int flag = FenYe.getFlag("hbPage");
	int maxnum = FenYe.getMaxnum("hbSize");
	int pagenum = FenYe.getnum("hbSize", 10);
%>
		...
		<div id="widget table-widget">
			...
			<div class="pageColumn">
				...
				<table>
					...
					<tbody>
						<h:iterator value="hongBaos" var="u">
							<tr>
						...
						<tr class=" ">
							...
							<td colspan="7" class="checkBox">共找到 <%=maxnum%>
								...
								href="getHongBao?page=<%=flag - 1%>" class="STYLE6">上页</a> <a
								href="getHongBao?page=<%=1 >= pagenum ? pagenum : 1%>" class="STYLE6">1</a>&nbsp;
								<a href="getHongBao?page=<%=2 >= pagenum ? pagenum : 2%>"
								class="STYLE6">2</a>&nbsp; <a
								href="getHongBao?page=<%=3 >= pagenum ? pagenum : 3%>" class="STYLE6">3</a>&nbsp;
								<a href="getHongBao?page=<%=4 >= pagenum ? pagenum : 4%>"
								class="STYLE6">4</a>&nbsp; <a
								href="getHongBao?page=<%=5 >= pagenum ? pagenum : 5%>" class="STYLE6">5</a>&nbsp;
								<a href="getHongBao?page=<%=6 >= pagenum ? pagenum : 6%>"
								class="STYLE6">6</a>&nbsp; <a
								href="getHongBao?page=<%=7 >= pagenum ? pagenum : 7%>" class="STYLE6">7</a>&nbsp;
								<a href="getHongBao?page=<%=8 >= pagenum ? pagenum : 8%>"
								class="STYLE6">8</a>&nbsp; <a
								href="getHongBao?page=<%=9 >= pagenum ? pagenum : 9%>" class="STYLE6">9</a>&nbsp;
								<a href="getHongBao?page=<%=10 >= pagenum ? pagenum : 10%>"
								class="STYLE6">10</a>&nbsp; <a
								href="getHongBao?page=<%=(flag + 1) >= pagenum ? pagenum : (flag + 1)%>"
								class="STYLE6">下页&gt;</a>&nbsp;
							</td>
						</tr>
					</tbody>
