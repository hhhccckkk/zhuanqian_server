...
<%
	int flag = FenYe.getFlag("tgbPage");
	int maxnum = FenYe.getMaxnum("tgbSize");
	int pagenum = FenYe.getnum("tgbSize", 12);
%>
						...
						<h:iterator value="tgApps" var="t">
							<tr>
								...
								<td><a href="getOneUser?id=<h:property value="#t.uid"/>"><h:property
											value="#t.uid" /></a></td>
								<td><h:property value="#t.downUrl"/></td>
								<td><h:property value="#t.size"/></td>
								
								<td><a href="deleteTGB?id=<h:property value="#t.id"/>">
